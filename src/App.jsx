...
const TEAM_COLORS = {
  // Equipes internas
  'Squad Palermo':                '#5B3FA0',
  'Gerentes de Contas':           '#8A4500',
  'Interno BMO':                  '#5A584F',
  // Clientes — Squad Palermo (ordem do sistema interno)
  'Clínica Rached':               '#C0392B',
  'Clínica Suzuki':               '#4A3FA0',
  'EndoDerma':                    '#1A6B4A',
  'Instituto Leonardo Junqueira': '#0B57D0',
  'Loureiro Clinic':              '#6D4C41',
  'Luiz Felipe':                  '#00796B',
  'Clínica Calvet':               '#8A5A00',
  'Injecta MedInfuse':            '#1A4D8F',
  'Natalia Dyna':                 '#7B1FA2',
  'Evidence':                     '#1565C0',
  'Duo Una':                      '#2E7D32',
  'Leandro Barreto':              '#8A2060',
  'Instituto K.D.':               '#3949AB',
  'Marina Alves':                 '#D84315',
  'Mais Saúde':                   '#00838F',
  'Instituto Essencia':           '#558B2F',
  'Prevnner Clínica Médica':      '#1A4D8F',
}
...
// Lista completa — espelha o sistema interno BMO (Squad Palermo)
const ALL_CLIENTS = [
  { key: 'Clínica Rached',               color: '#C0392B' },
  { key: 'Clínica Suzuki',               color: '#4A3FA0' },
  { key: 'EndoDerma',                    color: '#1A6B4A' },
  { key: 'Instituto Leonardo Junqueira', color: '#0B57D0' },
  { key: 'Loureiro Clinic',              color: '#6D4C41' },
  { key: 'Luiz Felipe',                  color: '#00796B' },
  { key: 'Clínica Calvet',               color: '#8A5A00' },
  { key: 'Injecta MedInfuse',            color: '#1A4D8F' },
  { key: 'Natalia Dyna',                 color: '#7B1FA2' },
  { key: 'Evidence',                     color: '#1565C0' },
  { key: 'Duo Una',                      color: '#2E7D32' },
  { key: 'Leandro Barreto',              color: '#8A2060' },
  { key: 'Instituto K.D.',               color: '#3949AB' },
  { key: 'Marina Alves',                 color: '#D84315' },
  { key: 'Mais Saúde',                   color: '#00838F' },
  { key: 'Instituto Essencia',           color: '#558B2F' },
  { key: 'Prevnner Clínica Médica',      color: '#1A4D8F' },
]
